...
import { FaFlask, FaRobot, FaCloudSun, FaRegUserCircle, FaPython, FaDatabase, FaHtml5, FaCss3Alt, FaJsSquare, FaGithub, FaLinkedin, FaEnvelope, FaDiscord, FaFilePdf } from 'react-icons/fa';
...
export default function Home() {
  ...
  return (
    <main>
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center pt-0 md:pt-0 pb-[32px] md:pb-[48px] min-h-[60vh]" id="hero">
        <h1 className="text-2xl md:text-4xl font-bold text-center max-w-2xl mx-auto">
          Hi, I'm <span style={{ color: 'var(--primary)', transition: 'color 0.3s' }} className="dark:text-[var(--accent)]">Sai Raghavan Commandur</span> - passionate about building impactful software and engineering elegant solutions.
        </h1>
      </section>
      {/* Divider */}
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12 md:gap-24 px-4 items-start">
          ...
          <div className="flex-1 flex flex-col items-center md:items-start md:justify-start justify-center min-h-[480px]">
            ...
            <div className="w-full max-w-xl">
              <p className="text-lg md:text-xl text-center md:text-left text-text/80">
                I'm a first year B.Sc. Computer Science student at the University of Surrey, passionate about full-stack web development, software engineering principles, and building impactful, scalable solutions.<br /><br />
                I enjoy crafting modern, responsive web applications using technologies like JavaScript, Node.js, HTML/CSS, and cloud infrastructure, with a focus on user experience and accessibility.<br /><br />
              ...
              <div className="mt-8 w-full">
                ...
                <div className="code-language-buttons flex flex-col gap-2">
                  ...
                  <button className="cl-button relative flex items-center justify-center w-full">
                    ...
                    <span className="w-full text-center">SQL</span>
                  </button>
                  <button className="cl-button relative flex items-center justify-center w-full">
              ...
              <div className="mt-8 w-full">
                ...
                <div className="profile-links-list flex flex-col gap-2">
                  ...
                  <a className="profile-link-item relative flex items-center justify-center gap-2" href="mailto:raghavcommandur@gmail.com">
                  ...
                  <a className="profile-link-item relative flex items-center justify-center gap-2" href="/src/assets/CV.pdf" download>
          ...
          <div className="flex-1 flex flex-col items-center md:items-start md:justify-start justify-center min-h-[480px]" id="projects">
            ...
            <p className="mb-4 text-text/70">Constantly learning frameworks & coding languages to build better things!</p>
            <div className="grid gap-6 w-full">
              {subjects.map((subject, index) => (
                <div className="rounded-xl border border-accent/30 bg-background/60 p-6 shadow-md flex flex-col gap-2" key={index}>
                  <div className="flex items-center gap-3 mb-1">{subject.icon}<h3 className="text-xl font-bold">{subject.title}</h3></div>
                  <div className="flex flex-wrap gap-2 mb-1">
                    {subject.technologies.map((tech, i) => (
                      <span key={i} className="px-2 py-0.5 rounded bg-accent/10 text-accent text-xs font-semibold">{tech}</span>
                    ))}
                  </div>
                  <p className="text-text/80 text-sm mb-2">{subject.description}</p>
                  <div className="flex gap-3 flex-wrap">
                    <a href={subject.repoLink} target="_blank" rel="noopener noreferrer" className="repo-button underline text-accent font-semibold">View Repository Code</a>
                    {subject.liveLink && (
